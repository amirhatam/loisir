                ...
                <MDBRow className='justify-content-around'>
                    ...
                    <MDBCol className='col-md-4 col-9 my-4'>
                        <MDBCard >
                            ...
                            <MDBCardBody>
                                <MDBCardTitle className='text-uppercase h5-fs'>Jeu des petits chevaux</MDBCardTitle>
                                <MDBCardText className='lighter text-justify p-fs'>
                    ...
                    <MDBCol className='col-md-4 col-9 my-4'>
                        <MDBCard >
                            ...
                            <MDBCardBody>
                                <MDBCardTitle className='text-uppercase h5-fs'>Hangman</MDBCardTitle>
